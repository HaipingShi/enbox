...
为「想直接用英语和 AI 对话 / vibe coding，顺便学英语」的场景设计：上框用中文描述想法，下框给你**可以直接发给 AI 助手的地道英文**，译文自动复制，并附少量中文学习笔记。窗口常驻悬浮、贴边折叠、全局热键随时呼出。
...
- **英语教练提示词**（默认，可自由修改）：第一段输出纯英文译文（代码术语原样保留、只转述不回答），空一行后附 1–3 条 💡 中文学习笔记；「复制英文」只复制译文，不会带上笔记
